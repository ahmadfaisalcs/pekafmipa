...
@section('page-title')
  Cek Kelengkapan Permohonan Cuti Akademik
@endsection
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <select name="program_studi" class="form-control">
                        ...
                        <option value="bio" @if($form->prodi == 'bio') Selected=""
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    <div class="col-sm-8 col-sm-offset-1">
                      ...
                      <p class="help-block"><a href="{{ url('storage/app/'.$lampiran->srt_cuti) }}" target="_blank">Lihat</a> Surat Permohonan yang telah diupload.</p>
                    </div>
                    <div class="col-sm-2">
                      <div class="checkbox">
                        <label>
                          <input name="chek_srt_cuti" class="cek" type="checkbox" value="Surat Permohonan Cuti">
                          Lengkap
                        </label>
                      </div>
                    </div>
            ...
            <div class="modal fade" id="berkaslengkap" tabindex="-1"  aria-labelledby="myModalLabel">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    <h4 class="modal-title" id="myModalLabel">Form Verifikasi Dokumen Surat Cuti Akademik (Bagian Tendik Adm. Pendidikan)
                    </h4>
                    <p><small>POB/FMIPA-ADM/10/FRM-02-02 ; Tgl. 01/10/2015</small></p>
                   </div>
                  <div class="modal-body">
                    <div class="form-group">
