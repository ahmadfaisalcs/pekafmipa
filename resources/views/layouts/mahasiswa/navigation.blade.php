    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown notifications-menu notif">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
          ...
          <span class="label label-warning">
            <span id="count">{{ count(\App\Applicant::find(Session::get('id'))->unreadnotifications) }}</span>
          </span>
        </a>
        <ul class="dropdown-menu" id="notification_content">
          @if (count(\App\Applicant::find(Session::get('id'))->unreadnotifications) > 0)
            <li>
              <!-- inner menu: contains the actual data -->
              <ul class="menu">
                @foreach (\App\Applicant::find(Session::get('id'))->unreadnotifications as $note)
                  <li>
                    <a href="">
      ...
      <li class="dropdown user user-menu">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
          ...
          <span class="hidden-xs">{{ Session::get('mhs_name') }}</span>
        </a>
