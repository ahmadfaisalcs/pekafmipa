        ...
        <div class="box">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <label class="control-label">FRM/FMIPA-ADM/09a - <b>Surat Keterangan</b></label>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                <label class="control-label">3 Hari</label>
              </div>
            </div>
            <!-- form -->
            <form action="{{ route('qo_09a') }}" method="post">
            ...
            <table class="table table-hover">
              <thead class="with-border" align="center" vertical-align="middle" >
                <tr>
                  ...
                  <td colspan="3" align="center"><b>Relasi Waktu Pelayanan</b></td>
                  <td colspan="2" align="center"><b>Prosentasi</b></td>
