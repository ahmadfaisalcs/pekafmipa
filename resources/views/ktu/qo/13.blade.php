...
@section('page-title')
  Surat Sidang Komisi Pascasarjana
@endsection
        ...
        <div class="box">  
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <label class="control-label">FRM/FMIPA-ADM/13 - <b>Surat Sidang Komisi Pascasarjana</b></label>
              </div>
            </div>
            <div class="form-group">
            ...
            <!-- form -->
            <form action="{{ route('qo_13') }}" method="post">
