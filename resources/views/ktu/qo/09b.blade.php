...
@section('page-title')
  Surat Keterangan Aktif Kuliah Untuk Tunjangan Anak
@endsection
        ...
        <div class="box">
          <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <label class="control-label">FRM/FMIPA-ADM/09b - <b>Surat Keterangan Aktif Kuliah Untuk Tunjangan Anak</b></label>
                </div>
              </div>
              <div class="form-group">
              ...
              <!-- form -->
            <form action="{{ route('qo_09b') }}" method="post">
