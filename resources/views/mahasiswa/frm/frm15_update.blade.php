...
@section('data-content')
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        <form class="" action="{{ route('update_frm_15') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <p class="help-block"><a href="{{ url('storage/app/'.$lampiran->spp) }}" target="_blank">Lihat</a> Tanda Bukti yang telah diupload.</p>
                    <p class="help-block">Atau lampirkan file baru:</p>
                ...
                <div class="callout callout-warning col-md-6">
                  <h5 align="center">Skripsi dan CD 1 (satu) buah</h5>
                  <p align="center">Dibawa ke TU setelah permohonan selesai</p>
                </div>
                <!-- warning -->
