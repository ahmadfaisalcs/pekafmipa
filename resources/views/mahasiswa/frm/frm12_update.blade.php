...
@section('header-content')
  <section class="content-header col-md-8 col-md-offset-2">
    <h1 align="center">
      Formulir Data Mahasiswa Yang Mengajukan Undur Diri
    </h1>
    <p></p>
  </section>
@endsection
...
@section('data-content')
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        <form class="" action="{{ route('update_frm_12') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <p class="help-block"><a href="{{ url('storage/app/'.$lampiran->srt_undurdiri) }}" target="_blank">Lihat</a> Surat Undur Diri yang telah diupload.</p>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <p class="help-block"><a href="{{ url('storage/app/'.$lampiran->srt_pengantar) }}" target="_blank">Lihat</a> Surat Pengantar yang telah diupload.</p>
                    <p class="help-block">Atau lampirkan file baru:</p>
