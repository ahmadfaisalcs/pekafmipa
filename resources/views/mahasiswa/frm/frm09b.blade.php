...
@section('page-title')
  Formulir Surat Keterangan Aktif Kuliah Untuk Tunjangan Anak
@endsection
...
@section('header-content')
  <section class="content-header col-md-8 col-md-offset-2">
    @if (!$isfill)
      <h1 align="center">
        Formulir Data Mahasiswa Yang Mengajukan Surat Keterangan Aktif Kuliah Untuk Tunjangan Anak
      </h1>
      <p></p>
    @endif
  </section>
  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        <form class="" action="{{ route('submit_frm_09b') }}" method="post" enctype="multipart/form-data">
          <!-- kalau mhs sudah mengisi kuisioner, form kuisioner tidak usah ditampilkan lagi -->
          @if ($isfill)
            <div class="callout callout-info">
              <h2>Anda Telah Mengisi FRM-09b</h2>

              <p>Terimakasih, anda telah mengisi <b>Formulir Permohonan Surat Keterangan Aktif Kuliah Untuk Tunjangan Anak.</b> Jika anda ingin mengajukan permohonan kembali, tunggu hingga permohonan sebelumnya selesai diproses.</p>
          ...
          @else
                ...
                <div class="box-body">
                 <!-- Nama -->
                  ...
                  <div class="form-group {!! $errors->has('utk_keperluan') ? 'has-error' : '' !!}">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="utk_keperluan" name="utk_keperluan" placeholder="misal: Tunjangan" value="{{Request::old('utk_keperluan')}}">
                    </div>
                  </div>
                  <!-- Telp -->
              ...
              <div class="form-horizontal">
                <div class="box-body">
                  ...
                  <div class="form-group {!! $errors->has('nama_ortu') ? 'has-error' : '' !!}">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="nama_ortu" name="nama_ortu" placeholder="misal: Alfulani" value="{{Request::old('nama_ortu')}}">
                    </div>
                  </div>
                  <!-- NIP -->
                  <div class="form-group {!! $errors->has('nip') ? 'has-error' : '' !!}">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="nip" name="nip" placeholder="misal: 198503302003121002" value="{{Request::old('nip')}}">
                    </div>
                  </div>
                  <!-- Pangkat golongan -->
                  <div class="form-group {!! $errors->has('pangkat') ? 'has-error' : '' !!}">
                    <label for="program_studi" class="col-sm-3 control-label">Pangkat Golongan</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="pangkat" name="pangkat" placeholder="misal: IV/e" value="{{Request::old('pangkat')}}">
                    </div>
                  </div>
                  <!-- Instansi -->
                  <div class="form-group {!! $errors->has('instansi') ? 'has-error' : '' !!}">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="instansi" name="instansi" placeholder="misal: FMIPA IPB" value="{{Request::old('instansi')}}">
                    </div>
                  </div>
                  <!-- Telp -->
                  <div class="form-group {!! $errors->has('telp_ortu') ? 'has-error' : '' !!}">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="telp_ortu" name="telp_ortu" placeholder="misal: 0850123456" value="{{Request::old('telp_ortu')}}">
                    </div>
                  </div>
                </div>
                <!-- /.box-body -->
            ...
            <!-- terimakasih -->
            <div class="callout callout-info">
              <p align="center">Maksimal waktu pelayanan Surat Keterangan Aktif Kuliah Untuk Tunjangan Anak adalah <strong>3 Hari</strong>. Cek menu <strong>Status Permohonan</strong> untuk mengetahui status formulir permohonan</p>
