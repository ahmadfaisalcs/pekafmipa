...
@section('data-content')
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        <form class="" action="{{ route('update_frm_10') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <p class="help-block"><a href="{{ url('storage/app/'.$lampiran->srt_cuti) }}" target="_blank">Lihat</a> Surat Permohonan Cuti yang telah diupload.</p>
