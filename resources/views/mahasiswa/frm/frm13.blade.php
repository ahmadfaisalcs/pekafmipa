...
@section('header-content')
  <section class="content-header col-md-8 col-md-offset-2">
    @if (!$isfill)
      <h1 align="center">
        Formulir Data Mahasiswa Yang Mengajukan Surat SIDKOM
      </h1>
      <p></p>
    @endif
  </section>
  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        <form class="" action="{{ route('submit_frm_13') }}" method="post" enctype="multipart/form-data">
          <!-- kalau mhs sudah mengisi kuisioner, form kuisioner tidak usah ditampilkan lagi -->
          @if ($isfill)
            <div class="callout callout-info">
              <h2>Anda Telah Mengisi FRM-13</h2>

              <p>Terimakasih, anda telah mengisi <b>Formulir Permohonan Surat Sidang Komisi Pascasarjana.</b> Jika anda ingin mengajukan permohonan kembali, tunggu hingga permohonan sebelumnya selesai diproses.</p>
              ...
              <div class="form-horizontal">
                <div class="box-body">
                  ...
                  <div class="form-group {!! $errors->has('utk_keperluan') ? 'has-error' : '' !!}">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="utk_keperluan" name="utk_keperluan" placeholder="misal: Sidang Komisi Pascasarjana" value="{{Request::old('utk_keperluan')}}">
                    </div>
                  </div>
                  <!-- Telp -->
                ...
                <div class="box-body">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="file" accept="application/pdf,image/*" id="srt_sidkom" name="srt_sidkom">
                    </div>
                  </div>
                  <!-- srt pengantar -->
                  <div class="col-md-6">
