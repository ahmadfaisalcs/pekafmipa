  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        <form class="" action="{{ route('submit_frm_09a') }}" method="post" enctype="multipart/form-data">
          <!-- kalau mhs sudah mengisi kuisioner, form kuisioner tidak usah ditampilkan lagi -->
          @if ($isfill)
            <div class="callout callout-info">
              <h2>Anda Telah Mengisi FRM-09a</h2>

              <p>Terimakasih, anda telah mengisi <b>Formulir Permohonan Surat Keterangan </b>untuk <b>{{ $lampiran->jenis_permohonan }}</b>. Jika anda ingin mengajukan permohonan kembali, tunggu hingga permohonan sebelumnya selesai diproses.</p>
          ...
          @else
              ...
              <div class="form-horizontal">
                <div class="box-body">
                  ...
                  <div class="form-group {!! $errors->has('utk_keperluan') ? 'has-error' : '' !!}">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="utk_keperluan" name="utk_keperluan" placeholder="misal: Beasiswa"
                      @if($jenis_permohonan == 'Beasiswa') value="Beasiswa"
                      @elseif($jenis_permohonan == 'Pembuatan Visa') value="Beasiswa"
                      @else value="Kehilangan KTM"
                      @endif>
                    </div>
                  </div>
                  <!-- Telp -->
            ...
            <div class="box box-info">
              ...
              <div class="form">
                <div class="box-body">
                  <!-- kalau beasiswa -->
                  @if($jenis_permohonan == 'Beasiswa')
                    <input type="hidden" name="jenis_permohonan" value="Beasiswa">
                    <!-- info -->
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="file" accept="application/pdf,image/*" id="surat" name="surat">
                      </div>
                    </div>
                    <!-- spp -->
                    <div class="col-md-6">
                  ...
                  <!-- kalau pembuatan visa -->
                  @elseif($jenis_permohonan == 'Pembuatan Visa')
                    <input type="hidden" name="jenis_permohonan" value="Pembuatan Visa">
                    <!-- info -->
                    <div class="col-md-12" align="center">
                      <div class="form-group">
                        <label for="">Kelengkapan berkas untuk surat pembuatan visa</label>
                      </div>
                    </div>
                    <!-- srt pengantar -->
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="file" accept="application/pdf,image/*" id="surat" name="surat" value="{{Request::old('surat')}}">
                      </div>
                    </div>
                    <!-- spp -->
                    <div class="col-md-6">
                  ...
                  <!-- kalau kehilangan ktm -->
                  @elseif($jenis_permohonan == 'Kehilangan KTM')
                    <input type="hidden" name="jenis_permohonan" value="Kehilangan KTM">
                    <!-- info -->
                    <div class="col-md-12" align="center">
                      <div class="form-group">
                        <label for="">Kelengkapan berkas untuk surat kehilangan KTM</label>
                      </div>
                    </div>
                    <!-- srt keterangan -->
                    <div class="col-md-6">
