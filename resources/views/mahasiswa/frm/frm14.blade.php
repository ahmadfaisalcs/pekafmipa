...
@section('page-title')
  Formulir Surat Perpanjangan Studi
@endsection
...
@section('header-content')
  <section class="content-header col-md-8 col-md-offset-2">
    @if (!$isfill)
      <h1 align="center">
        Formulir Data Mahasiswa Yang Mengajukan Surat Perpanjangan Studi
      </h1>
      <p></p>
    @endif
  </section>
  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        <form class="" action="{{ route('submit_frm_14') }}" method="post" enctype="multipart/form-data">
          <!-- kalau mhs sudah mengisi kuisioner, form kuisioner tidak usah ditampilkan lagi -->
          @if ($isfill)
            <div class="callout callout-info">
              <h2>Anda Telah Mengisi FRM-14</h2>

              <p>Terimakasih, anda telah mengisi <b>Formulir Permohonan Surat Perpanjangan Studi.</b> Jika anda ingin mengajukan permohonan kembali, tunggu hingga permohonan sebelumnya selesai diproses.</p>
              ...
              <div class="form-horizontal">
                <div class="box-body">
                  ...
                  <div class="form-group {!! $errors->has('utk_keperluan') ? 'has-error' : '' !!}">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="utk_keperluan" name="utk_keperluan" placeholder="misal: Perpanjangan Studi" value="{{Request::old('utk_keperluan')}}">
                    </div>
                  </div>
                  <!-- Telp -->
                ...
                <div class="box-body">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="file" accept="application/pdf,image/*" id="srt_rencanastudi" name="srt_rencanastudi">
                    </div>
                  </div>
                  <!-- download -->
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <button type="button" accept="application/pdf,image/*" class="btn btn-block btn-primary">Download</button>
                    </div>
                  </div>
                </div>
                <!-- /.box-body -->
