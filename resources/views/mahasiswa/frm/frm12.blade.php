...
@section('header-content')
  <section class="content-header col-md-8 col-md-offset-2">
    @if (!$isfill)
      <h1 align="center">
        Formulir Data Mahasiswa Yang Mengajukan Surat Undur Diri
      </h1>
      <p></p>
    @endif
  </section>
  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        <form class="" action="{{ route('submit_frm_12') }}" method="post" enctype="multipart/form-data">
          <!-- kalau mhs sudah mengisi kuisioner, form kuisioner tidak usah ditampilkan lagi -->
          @if ($isfill)
            <div class="callout callout-info">
              <h2>Anda Telah Mengisi FRM-12</h2>

              <p>Terimakasih, anda telah mengisi <b>Formulir Permohonan Surat Undur Diri.</b> Jika anda ingin mengajukan permohonan kembali, tunggu hingga permohonan sebelumnya selesai diproses.</p>
          ...
          @else
              ...
              <div class="form-horizontal">
                <div class="box-body">
                  ...
                  <div class="form-group {!! $errors->has('utk_keperluan') ? 'has-error' : '' !!}">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="utk_keperluan" name="utk_keperluan" placeholder="misal: Pindah Perguruan Tinggi" value="{{Request::old('utk_keperluan')}}">
                    </div>
                  </div>
                  <!-- Telp -->
            ...
            <div class="box box-info">
              ...
              <div class="form">
                <div class="box-body">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="srt_undurdiri">Surat Permohonan undur diri dari mahasiswa dan orangtua/wali</label>
                      <input type="file" accept="application/pdf,image/*" id="srt_undurdiri" name="srt_undurdiri">
                    </div>
                  </div>
                  <!-- srt pengantar -->
                  <div class="col-md-6">
                  ...
                  <div class="callout callout-warning col-md-12">
                    <h5 align="center">KTM asli wajib dibawa ke TU setelah permohonan selesai diproses</h5>
                  </div>
                <!-- /.box-body -->
                </div>
              </div>
            ...
            <!-- terimakasih -->
            <div class="callout callout-info">
              <p align="center">Maksimal waktu pelayanan Surat Undur Diri adalah <strong>5 Hari</strong>. Cek menu <strong>Status Permohonan</strong> untuk mengetahui status formulir permohonan</p>
