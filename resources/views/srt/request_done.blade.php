...
@section('page-title')
  Daftar Permohonan Yang Telah Selesai Diproses
@endsection
                ...
                <tbody>
                  @foreach ($requests as $request)
                    <tr role="row" class="odd">
                        ...
                        <td><span class="label label-success">Telah Selesai</span>
                          {{-- <button data-target="#gantistatus{{ $request->id }}" data-toggle="modal" type="button" name="button"><i class="fa fa-edit" title="Edit status permohonan"></i></button> --}}
                          {{-- <span class="label"><i data-target="#gantistatus{{ $request->id }}" data-toggle="modal" class="fa fa-edit" title="Edit status permohonan"></i></span> --}}
                        </td>
                      </tr>
                  {{-- 2017-06-06 --}}
                    <!-- modal ganti status -->
