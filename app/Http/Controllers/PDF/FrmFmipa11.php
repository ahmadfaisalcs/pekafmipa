<?php
	...
	*/
    class FrmFmipa11 extends Surat {
        ...
        function GenerateSurat() {
            ...
            $pdf:: Cell(0, 5, 'FORMULIR DATA MAHASISWA YANG MENGAJUKAN AKTIF KEMBALI', 0, 1, 'C');
            $pdf:: SetFont('Arial', '',10);
            $pdf:: Cell(0, 5,'POB/FMIPA-ADM/11/FRM-01-01 ; Tgl. 01/10/2015', 0,1, 'C');
            $pdf:: Ln(5);
            ...
            $pdf:: Ln(1);
            $pdf:: Cell(95, 5, '       1.   Surat Cuti', 0, 0, 'L');
            $pdf:: Cell(5, 5, 'X' , 1, 1, 'L');
            $pdf:: Ln(1);
            $pdf:: Cell(95, 5, '       2.   Surat Pengantar Departemen', 0, 0, 'L');
            $pdf:: Cell(5, 5, 'X' , 1, 1, 'L');
            $pdf:: Cell(95, 5, '       3.   Fotocopy SPP', 0, 0, 'L');
            $pdf:: Cell(5, 5, 'X' , 1, 1, 'L');
            $pdf:: Cell(95, 5, '       4.   Fotocopy KTM', 0, 0, 'L');
            $pdf:: Cell(5, 5, 'X' , 1, 1, 'L');
            ...
            $pdf:: Cell(0,5, "Verifikasi Dokumen Surat Aktif Kembali", 0, 1, 'C');
            $pdf:: SetFont('Arial', '', 10);
            $pdf:: Cell(0,5,'POB/FMIPA-ADM/11/FRM-02-02; Tgl. 01/10/2015', 0, 0, 'C');
            $pdf:: Ln(10);
