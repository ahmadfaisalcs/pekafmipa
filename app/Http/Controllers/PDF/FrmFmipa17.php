<?php
	...
	use Fpdf;
    class FrmFmipa17 extends Surat {
        ...
        function GenerateSurat() {
            ...
            $pdf:: Cell(0, 5, 'FORMULIR DATA MAHASISWA YANG MENGAJUKAN LEGALISIR', 0, 1, 'C');
            $pdf:: SetFont('Arial', '',10);
            $pdf:: Cell(0, 5,'POB/FMIPA-ADM/17/FRM-01-01 ; Tgl. 01/10/2015', 0,1, 'C');
            $pdf:: Ln(5);
            ...
            $pdf::Cell(40, 7, "4.  Untuk Keperluan", 0,0,'L');
            $pdf::Cell(0, 7, ":  ".$this->alasan_pemohon, 0,1,'L');
            $pdf::Cell(40, 7, "5.  Tlp/HP", 0,0,'L');
            $pdf::Cell(0, 7, ":  ".$this->tlpn_pemohon, 0,1,'L');
            $pdf::Cell(40, 7, "6.  E-mail", 0,0,'L');
            ...
            $pdf:: Ln(3);
            $pdf:: Cell(60, 5, '*      Persyaratan', 0, 1, 'L');
            $pdf:: Ln(1);
            $pdf:: Cell(95, 5, '       1.   Menunjukan dokumen asli', 0, 0, 'L');
            $pdf:: Cell(5, 5, 'V', 1, 1, 'L');
            $pdf:: Ln(1);
            $pdf:: Cell(95, 5, '       2.   Fotocopy dokumen', 0, 0, 'L');
            $pdf:: Cell(5, 5, 'V', 1, 1, 'L');
            ...
            $pdf:: Cell(0,5, "Verifikasi Dokumen Legalisir", 0, 1, 'C');
            $pdf:: SetFont('Arial', '', 10);
            $pdf:: Cell(0,5,'POB/FMIPA-ADM/17/FRM-02-02; Tgl. 01/10/2015', 0, 0, 'C');
            $pdf:: Ln(10);
