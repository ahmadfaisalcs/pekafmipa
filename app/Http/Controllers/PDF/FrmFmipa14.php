<?php
	...
	*/
class FrmFmipa14 extends Surat
{
	...
	function GenerateSurat()
	{
	    ...
	    $pdf::Cell(0,7,"FORMULIR DATA MAHASISWA YANG MENGAJUKAN PERPANJANGAN STUDI",0,1,'C');
	    $pdf::SetFont('Arial','',10);
	    $pdf::Cell(0,5,"POB/FMIPA-ADM/14/FRM-01-01 ; Tgl. 01/10/2015",0,1,'C');
	    $pdf::Ln(2);
	    ...
	    $pdf::Ln(4);
	    $pdf::Cell(6, 4, "", 0,0,'L');
	    $pdf::Cell(85, 4, "Surat pernyataan Rencana Penyelesaian Studi", 0,0,'L');
	    ...
	    $pdf::Cell(6, 4, "", 0,0,'L');
	  	...
	  	$pdf::Ln(0);
            ...
            $pdf:: Cell(0,5, "Verifikasi Dokumen Surat Perpanjangan Studi", 0, 1, 'C');
            $pdf:: SetFont('Arial', '', 10);
            $pdf:: Cell(0,5,'POB/FMIPA-ADM/14/FRM-02-02 ; Tgl. 01/10/2015', 0, 0, 'C');
            $pdf:: Ln(10);
