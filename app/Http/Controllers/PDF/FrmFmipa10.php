<?php
	...
	*/
class FrmFmipa10 extends Surat
{
	...
	function GenerateFRM_FMIPA_10()
	{
	    ...
	    $pdf::Cell(0,7,"FORMULIR DATA MAHASISWA YANG MENGAJUKAN CUTI AKADEMIK",0,1,'C');
	    $pdf::SetFont('Arial','',10);
	    $pdf::Cell(0,5,"POB/FMIPA-ADM/10/FRM-01-01; Tgl. 01/10/2015",0,1,'C');
	    $pdf::Ln(2);
	    ...
	    $pdf::Cell(79, 4, "Surat Permohonan Cuti dari mahasiswa dan wali", 0,0,'L');
	    $pdf::SetFont('Arial','',12);
	    $pdf::Cell(5, 4, 'V', 1,1,'L');
	    $pdf::SetFont('Arial','',10);
	    $pdf::Cell(6, 4, "", 0,0,'L');
	  	$pdf::Cell(6, 4, "2.", 0,0,'L');
	    $pdf::Cell(79, 4, "Surat Pengantar Departement", 0,0,'L');
	    $pdf::SetFont('Arial','',12);
	    $pdf::Cell(5, 4, 'V', 1,1,'L');
	    $pdf::SetFont('Arial','',10);
	  	$pdf::Cell(6, 4, "", 0,0,'L');
	  	$pdf::Cell(6, 4, "3.", 0,0,'L');
	    $pdf::Cell(79, 4, "Fotocopy SPP", 0,0,'L');
	    $pdf::SetFont('Arial','',12);
	    $pdf::Cell(5, 4, 'V', 1,1,'L');
	    $pdf::SetFont('Arial','',10);
	    $pdf::Cell(6, 4, "", 0,0,'L');
	  	$pdf::Cell(6, 4, "4.", 0,0,'L');
	    $pdf::Cell(79, 4, "Fotocopy KTM", 0,0,'L');
	    $pdf::SetFont('Arial','',12);
	    $pdf::Cell(5, 4, 'V', 1,1,'L');
	    $pdf::SetFont('Arial','',10);
	    $pdf::Ln(10);
	    $pdf::Cell(6, 4, "", 0,0,'L');
	  	...
	  	$pdf::Ln(0);
            ...
            $pdf:: Ln(0.5);
            $pdf:: SetFont('Arial', 'BU', 14);
            $pdf:: Cell(0,5, "Verifikasi Dokumen Surat Cuti Akademik", 0, 1, 'C');
            $pdf:: SetFont('Arial', '', 10);
            $pdf:: Cell(0,5,'POB/FMIPA-ADM/10/FRM-02-02; Tgl. 01/10/2015', 0, 0, 'C');
            $pdf:: Ln(10);
