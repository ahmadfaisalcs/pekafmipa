<?php
	...
	*/
    class FrmFmipa13 extends Surat {
        ...
        function GenerateSurat() {
            ...
            $pdf:: Cell(0, 5, 'FORMULIR DATA MAHASISWA YANG MENGAJUKAN SIDANG KOMISI PASCASARJANA', 0, 1, 'C');
            $pdf:: SetFont('Arial', '',10);
            $pdf:: Cell(0, 5,'POB/FMIPA-ADM/13/FRM-01-01 ; Tgl. 01/10/2015', 0,1, 'C');
            $pdf:: Ln(5);
            ...
            $pdf:: Ln(1);
            $pdf:: Cell(95, 5, '       1.   Surat Pengajuan sidang komisi dari program studi', 0, 0, 'L');
            $pdf:: Cell(5, 5, 'V', 1, 1, 'L');
            $pdf:: Ln(1);
            $pdf:: Cell(95, 5, '       2.   Bukti lunas SPP', 0, 0, 'L');
            $pdf:: Cell(5, 5, 'V', 1, 1, 'L');
            ...
            $pdf:: Cell(0,5, "Verifikasi Dokumen Surat Sidang Komisi Pascasarjana", 0, 1, 'C');
            $pdf:: SetFont('Arial', '', 10);
            $pdf:: Cell(0,5,'POB/FMIPA-ADM/13/FRM-02-02; Tgl. 01/10/2015', 0, 0, 'C');
            $pdf:: Ln(10);
